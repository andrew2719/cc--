...
def ashtonString(s, k):
    ...
    # return sub_strings[k-1]
    
    kv = k - 1 # kv means k value
    N = len(s)
    sr = [[0 for _ in range(N)] for __ in range(17)] # sparse table, we took 17 because 2^17 > 10^5
    sr[0] = [ord(c)-97 for c in s] # 97 is the ascii value of 'a'
